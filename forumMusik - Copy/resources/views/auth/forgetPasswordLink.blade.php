    ...
    <form action="{{ route('reset.password.post') }}" method="POST">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                ...
                <input type="text" id="email" placeholder="Email" class="form-control" name="email" required autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                ...
                <input type="password" id="password-confirm" placeholder="Confirm New Password" class="form-control" name="password_confirmation" required autofocus>
