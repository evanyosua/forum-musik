...
<body>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <input id="nama" placeholder="Name" type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{ old('nama') }}" required autocomplete="nama" autofocus>
        ...
        <div class="social">
            <span class="text-center">Have an account?</span>
